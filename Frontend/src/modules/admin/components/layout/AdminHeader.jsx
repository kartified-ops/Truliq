...
const AdminHeader = ({ onMenuClick }) => {
  ...
  const getPageInfo = (pathname) => {
    const mappings = [
      ...
      { path: '/admin/settings/business', title: 'Business Settings', description: 'Configure charges, commissions, and financial rules' },
      { path: '/admin/settings/app', title: 'App Settings', description: 'Configure system preferences, booking modes, and contact info' },
      { path: '/admin/settings/third-party', title: 'Third-party Settings', description: 'Configure third-party payment, SMS, maps, and mail integrations' },
      { path: '/admin/settings/profile', title: 'Profile Settings', description: 'Manage your personal account details and password' },
      { path: '/admin/settings/cities', title: 'City Management', description: 'Manage operational cities and locations' },
      { path: '/admin/settings/admins', title: 'Admin Management', description: 'Add, remove, and view system administrators' },
      { path: '/admin/settings', title: 'Settings', description: 'Configure platform preferences and integrations' },
      ...
      { path: '/admin/promotional-offers', title: 'Promotional Offers', description: 'Create festival offers that pause subscriptions and waive platform fees' },
