  ...
  useEffect(() => {
    ...
    const fetchContent = async () => {
      ...
      if (data?.success && data.settings?.privacyPolicy) {
        setContent(data.settings.privacyPolicy);
      } else {
        setContent('<p>Privacy Policy will be updated soon.</p>');
      }
      setLoading(false);
    };
    ...
    <div className="min-h-screen bg-slate-50 font-sans" ref={containerRef}>
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm animate-item">
        <div className="max-w-screen-xl mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <Logo className="h-14 md:h-16 w-auto absolute left-1/2 -translate-x-1/2" />
      ...
      <section className="pt-8 pb-6 px-6 overflow-hidden relative">
        ...
        <div className="max-w-3xl mx-auto relative z-10 text-center animate-item">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
            Privacy <span style={TruliqTextGradient}>Policy</span>
          </h1>
          <p className="text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto">
            Your privacy is critically important to us. Learn how we protect it.
          </p>
        </div>
      </section>
