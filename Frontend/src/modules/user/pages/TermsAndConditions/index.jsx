...
const TermsAndConditions = () => {
  ...
  useEffect(() => {
    ...
    const fetchContent = async () => {
      ...
      if (data?.success && data.settings?.termsAndConditions) {
        setContent(data.settings.termsAndConditions);
      } else {
        setContent('<p>Terms and Conditions will be updated soon.</p>');
      }
      setLoading(false);
    };
      ...
      <section className="pt-8 pb-6 px-6 overflow-hidden relative">
        ...
        <div className="max-w-3xl mx-auto relative z-10 text-center animate-item">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
            Terms & <span style={TruliqTextGradient}>Conditions</span>
          </h1>
